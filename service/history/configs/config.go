...
type Config struct {
	...
	ReplicationStreamReceiverBlockRecv                  dynamicconfig.BoolPropertyFn
...
func NewConfig(
	...
	cfg := &Config{
		...
		ReplicationStreamReceiverBlockRecv:                  dynamicconfig.ReplicationStreamReceiverBlockRecv.Get(dc),
